...
public class GameJdbcDaoTest {
    ...
    private void initializeDataBase() {
        ...
        StringBuilder insert = new StringBuilder().append("")
                ...
                .append("VALUES (1, 'Mario', 'needs: Nintendo, Nintendo 64, Platformer', 0, '2018-12-30', 'whgrfj9muktnnpags6qg');\n")
                .append("INSERT INTO power_up.games\n")
                .append("VALUES (2, 'Super Mario Party', '', 0, '2018-12-30', 'fouukgohwdwhusnx05dx');\n")
                .append("INSERT INTO power_up.games VALUES (3, 'Sonic', 'SANIC.', 0, '2018-12-30', null);\n")
                .append("INSERT INTO power_up.games VALUES (4, 'Megaman I', 'Megaman .', 0, '2000-12-30', null);\n")
                .append("INSERT INTO power_up.games VALUES (5, 'Megaman II', '', 0, '2012-12-30', null);\n")
                .append("INSERT INTO power_up.games VALUES (6, 'Megaman III', 'Megaman!!', 0, '2014-12-30', null);\n")

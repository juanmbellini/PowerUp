...
DELETE FROM game_keywords AS g1 WHERE
  EXISTS(SELECT * from game_keywords AS g2 WHERE g1.id < g2.id AND g1.game_id = g2.game_id AND g1.keyword_id = g2.keyword_id);
...
DELETE FROM game_videos AS g1 WHERE
  EXISTS(SELECT * from game_videos AS g2 WHERE g1.id < g2.id AND g1.game_id = g2.game_id AND g1.video_id = g2.video_id);
